...
NB_NPROC=12 #(= 2 regions * 1 variable * 12 month)
...
for reg in GULFSTREAM; do
	for var in somxl010; do
		for month in $(seq 1 12); do
			echo './script_extract_surf_NATL60_1month.ksh '$reg' CJM165 1d '$var' '$month >> tmp_extract_mld_NATL60-CJM165_${reg}_m${month}.ksh
