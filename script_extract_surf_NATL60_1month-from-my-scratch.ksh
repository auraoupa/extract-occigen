...
for month in $MONTH; do
    ...
    for var in $VAR; do
      ...
      stdir=/scratch/cnt0024/ige2071/aalbert/${CONFIG}/${CONFIG}-${CASE}-S/${FREQ}/NATL60

      for file in $(ls $stdir/${CONFIG}-${CASE}_y${year}m${mm}d${dd}.${FREQ}_${var}_${SUFFIX}.nc); do

 	fileo=${CONFIG}${sREG}-${CASE}_y${year}m${mm}d${dd}.${FREQ}_${var}_${SUFFIX}.nc
	if [ ! -f  $fileo ]; then echo $fileo; ncks -O -F $coord $file $fileo; fi
